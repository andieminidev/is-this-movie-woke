  ...
  <div class="w-full max-w-4xl mx-auto mb-5">
    ...
    <div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-white/20 mb-8 md:mb-12">
      <div class="text-center mb-8">
        <div class="text-6xl font-bold text-white mb-2">{{ score.wokeScore }}% 🧐</div>
        <div class="text-xl text-purple-300 mb-4">Woke Score</div>
        <p class="text-gray-300 italic">
          "{{ getWokeComment(score.wokeScore) }}"
        </p>
      </div>
      ...
      <div class="max-w-2xl mx-auto">
        ...
        <p class="text-gray-300 mb-6">
          We analyzed {{ score.reviewCount }} reviews using our advanced algorithm that looks for specific 
    ...
    <div class="grid md:grid-cols-2 gap-6 md:gap-8">
      <div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-white/20">
        ...
        <div class="flex flex-wrap gap-2">
          <span v-for="theme in score.themes" 
                :key="theme"
      ...
      <div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-white/20">
        ...
        <div class="space-y-3 text-sm text-gray-300">
          <p v-for="(quote, i) in score.reviewQuotes" 
             :key="i"
             class="italic">
            "{{ quote }}"
          </p>
